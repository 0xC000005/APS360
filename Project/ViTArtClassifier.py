...
if __name__ == '__main__':
    ...
    vit = vit_b_16(weights=None).to(device)
    ...
    # save the model
    model_name = 'vit_ArtClassifier' + datetime.datetime.now().strftime("%Y%m%d%H%M%S") + '.pth'
    ...
    plt.savefig('vit_confusion_matrix' + datetime.datetime.now().strftime("%Y%m%d%H%M%S") + '.png')
    ...
    plt.grid(True)
    # Save the plot
    plt.savefig('vit_losses' + datetime.datetime.now().strftime("%Y%m%d%H%M%S") + '.png')
    plt.close()
    ...
    plt.grid(True)
    # Save the plot
    plt.savefig('vit_accuracy' + datetime.datetime.now().strftime("%Y%m%d%H%M%S") + '.png')
    plt.close()
