...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(
        ...
        batch_size=64,
        shuffle=True,
        num_workers=4,  # Reduce the number of workers
        pin_memory=True,
        drop_last=True,
    ...
    # train the model
    model, history = train(model, train_loader, val_loader, loss_fn, optimizer, num_epochs=60, device=device)
